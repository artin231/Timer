<h1>this is a timer that has to parts:</h1>
<p>timer normal</p>
<p>timer pro</p>

<h2> timer normal: </h2>
<p> a good timer that is so similar to the pro timer but the programers are not same </p>
<p> the normal timer UI is not better than the pro one but the to timers both do same things </p>
